...
SELECT cli.* , edades.edad FROM cliente as cli 
INNER JOIN edades on cli.customer_id = edades.customer_id 
WHERE edad > 40 ORDER by cli.customer_DNI 
...
SELECT cli.* , edades.edad FROM cliente as cli 
INNER JOIN edades on cli.customer_id = edades.customer_id 
WHERE cli.customer_name = "Anne" or cli.customer_name = "Tyler" ORDER by edades.edad
